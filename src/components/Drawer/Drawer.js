            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap component="div">
                        {location.pathname.slice(1).split('_').map((e, i) => (e.charAt(0).toUpperCase() + e.slice(1))).join(' ')}
                    </Typography>
                </Toolbar>
            </AppBar>
                    ...
                    {['/selection_sort', '/insertion_sort', '/bubble_sort', '/merge_sort', '/binary_search'].map((text, index) => (
                        <Link to={text} style={{textDecoration: 'none', color: 'inherit'}}>
                            <ListItem button key={text.slice(1).split('_').map((e, i) => (e.charAt(0).toUpperCase() + e.slice(1))).join(' ')}>
                                <ListItemIcon>
                                    {index % 2 === 0 ? <AutoAwesomeMotionIcon/> : <AutoAwesomeMotionIcon/>}
                                </ListItemIcon>
                                <ListItemText primary={text.slice(1).split('_').map((e, i) => (e.charAt(0).toUpperCase() + e.slice(1))).join(' ')} />
                            </ListItem>
                        </Link>
                    ))}
                </List>
